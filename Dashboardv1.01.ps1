...
.PARAMETER RightLogo
    ...
    -RightLogo "\\prep2012\departments\maintenance\PPLOGO.jpg"
...
param (
	...
	[Parameter(ValueFromPipeline = $true, HelpMessage = "\\prep2012\departments\maintenance\PPLOGO.jpg")]
	[String]$CompanyLogo = "\\prep2012\departments\maintenance\PPLOGO.jpg",
	#Logo that will be on the right side, UNC or URL

	[Parameter(ValueFromPipeline = $true, HelpMessage = "\\prep2012\departments\maintenance\PPLOGO.jpg")]
	[String]$RightLogo = "\\prep2012\departments\maintenance\PPLOGO.jpg",
	#Title of generated report

	[Parameter(ValueFromPipeline = $true, HelpMessage = "Enter desired title for report")]
	[String]$ReportTitle = "Chris' Premium Peanut Active Directory Report",
